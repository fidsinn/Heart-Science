...
```{r Train.glm, echo=TRUE, warning=FALSE}
...
```{r Train.random.forest.NEW, echo=TRUE, warning=FALSE}
#train random forest
Train.random.forest <- caret::train(disease ~ ., data=training,
                             method="rf",
                             preProcess=c("center","scale"),
